...
Citizen.CreateThread(function()
	...
	while true do
		...
		if not Config.OnlyPolicemen or (Config.OnlyPolicemen and ESX.PlayerData["job"] and ESX.PlayerData["job"]["name"] == "brinks") then
...
OpenWeaponStorage = function()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), "police_armory_weapon_menu",
		{
			title    = "Armurerie armes gruppe 6",
			align    = "center",
			elements = elements
		},
	function(data, menu)
